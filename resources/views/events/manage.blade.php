...
<div class="max-w-6xl mx-auto px-6 py-10">
    ...
    @if(session('success'))
        <div id="flashSuccess" class="mb-6 flex items-center gap-3 bg-green-50 border border-green-200 text-green-800 rounded-xl px-5 py-3 text-sm font-medium shadow-sm">
